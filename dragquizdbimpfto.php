...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
        ...
        $sql_query = "SELECT verb_sp, verb_en, primpyo, primptu, primpel, primpnos, primpvos, primpellos FROM verbs ORDER BY rand() LIMIT 1";
...
?>
	...
	<div id="answerDiv">
		<div class="dragDropSmallBox" id="a7"><?php echo $row["primpyo"]; ?></div>
		<div class="dragDropSmallBox" id="a1"><?php echo $row["primptu"]; ?></div>
		<div class="dragDropSmallBox" id="a2"><?php echo $row["primpel"]; ?></div>
		
		<div class="dragDropSmallBox" id="a3"><?php echo $row["primpnos"]; ?></div>
		<div class="dragDropSmallBox" id="a4"><?php echo $row["primpvos"]; ?></div>
		<div class="dragDropSmallBox" id="a5"><?php echo $row["primpellos"]; ?></div>
