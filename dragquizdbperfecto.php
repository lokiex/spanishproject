...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
        ...
        $sql_query = "SELECT verb_sp, verb_en, prpyo, prptu, prpel, prpnos, prpvos, prpellos FROM verbs ORDER BY rand() LIMIT 1";
...
?>
	...
	<div id="answerDiv">
		<div class="dragDropSmallBox" id="a7"><?php echo $row["prpyo"]; ?></div>
		<div class="dragDropSmallBox" id="a1"><?php echo $row["prptu"]; ?></div>
		<div class="dragDropSmallBox" id="a2"><?php echo $row["prpel"]; ?></div>
		
		<div class="dragDropSmallBox" id="a3"><?php echo $row["prpnos"]; ?></div>
		<div class="dragDropSmallBox" id="a4"><?php echo $row["prpvos"]; ?></div>
		<div class="dragDropSmallBox" id="a5"><?php echo $row["prpellos"]; ?></div>
