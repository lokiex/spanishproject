...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
        ...
        $sql_query = "SELECT 1s,2s,3s,1p,2p,3p FROM verbs500 WHERE mood_english = 'Indicative' AND tense_english='Preterite' ORDER BY rand() LIMIT 1";
...
?>
	...
	<div id="questionDiv">
		...
		<div class="dragDropSmallBox" id="q1"><?php echo $row["infinitive"]; ?>(t&#250;)</div>
		<div class="destinationBox"></div>
		<div class="dragDropSmallBox" id="q2"><?php echo $row["infinitive"]; ?>(&eacute;l / Ella / Usted)</div>
		<div class="destinationBox"></div>
		
		<div class="dragDropSmallBox" id="q3"><?php echo $row["infinitive"]; ?>(Nosotros)</div>
		<div class="destinationBox"></div>
		<div class="dragDropSmallBox" id="q4"><?php echo $row["infinitive"]; ?>(Vosotros)</div>
		<div class="destinationBox"></div>
		<div class="dragDropSmallBox" id="q5"><?php echo $row["infinitive"]; ?>(Ellos / Ellas / Ustedes)</div>
		<div class="destinationBox"></div>
		
		<div class="dragDropSmallBox" id="q6"><?php echo $row["infinitive"] ; ?> Meaning</div>
		<div class="destinationBox"></div>
	...
	<div id="answerDiv">
		...
		<div class="dragDropSmallBox" id="a1"><?php echo $row["2s"]; ?></div>
		<div class="dragDropSmallBox" id="a2"><?php echo $row["3s"]; ?></div>
		
		<div class="dragDropSmallBox" id="a3"><?php echo $row["1p"]; ?></div>
		<div class="dragDropSmallBox" id="a4"><?php echo $row["2p"]; ?></div>
		<div class="dragDropSmallBox" id="a5"><?php echo $row["3p"]; ?></div>
        <div class="dragDropSmallBox" id="a6"><?php echo $row["infinitive_english_1"]; ?></div>	
	</div>
</div><?php } ?>
