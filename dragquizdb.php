...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
        ...
        $sql_query = "SELECT verb_sp, verb_en, imp_aftu, imp_afel, imp_afnos,	imp_afvos, imp_afellos FROM verbs ORDER BY rand() LIMIT 1";
...
?>
	...
	<div id="answerDiv">
		...
		<div class="dragDropSmallBox" id="a1"><?php echo $row["imp_aftu"]; ?></div>
		<div class="dragDropSmallBox" id="a2"><?php echo $row["imp_afel"]; ?></div>
		
		<div class="dragDropSmallBox" id="a3"><?php echo $row["imp_afnos"]; ?></div>
		<div class="dragDropSmallBox" id="a4"><?php echo $row["imp_afvos"]; ?></div>
		<div class="dragDropSmallBox" id="a5"><?php echo $row["imp_afellos"]; ?></div>
