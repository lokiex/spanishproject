...
if (!$conn) {
    die("Connection failed: " . mysqli_connect_error());
        ...
        $sql_query = "SELECT * FROM tganeve WHERE type='pretérite' ORDER BY rand() LIMIT 1";
...
?>
	...
	<div id="questionDiv">
		...
		<div class="dragDropSmallBox" id="q1"><?php echo $row["verbo"]; ?>(t&#250;)</div>
		<div class="destinationBox"></div>
		<div class="dragDropSmallBox" id="q2"><?php echo $row["verbo"]; ?>(&eacute;l / Ella / Usted)</div>
		<div class="destinationBox"></div>
		
		<div class="dragDropSmallBox" id="q3"><?php echo $row["verbo"]; ?>(Nosotros)</div>
		<div class="destinationBox"></div>
		<div class="dragDropSmallBox" id="q4"><?php echo $row["verbo"]; ?>(Vosotros)</div>
		<div class="destinationBox"></div>
		<div class="dragDropSmallBox" id="q5"><?php echo $row["verbo"]; ?>(Ellos / Ellas / Ustedes)</div>
		<div class="destinationBox"></div>
		
		<div class="dragDropSmallBox" id="q6"><?php echo $row["verbo"] ; ?> Yo</div>
		<div class="destinationBox"></div>
	...
	<div id="answerDiv">
		...
		<div class="dragDropSmallBox" id="a1"><?php echo $row["tú"]; ?></div>
		<div class="dragDropSmallBox" id="a2"><?php echo $row["él"]; ?></div>
		<div class="dragDropSmallBox" id="a3"><?php echo $row["nosotros"]; ?></div>
		<div class="dragDropSmallBox" id="a4"><?php echo $row["vosotros"]; ?></div>
		<div class="dragDropSmallBox" id="a5"><?php echo $row["ellos"]; ?></div>
        <div class="dragDropSmallBox" id="a6"><?php echo $row["yo"]; ?></div>	
	</div>
</div><?php } ?>
